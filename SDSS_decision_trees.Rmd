...
paste("Test set MSE associated with bagged tree:", round(100*(1-sum(diag(test.results))/sum(test.results)),2),"%",sep="")
```
...
paste("Test set MSE associated with random forest: ", round(100*(1-sum(diag(test.results))/sum(test.results)),2),"%",sep="")
```
...
paste("Test set MSE associated with boosting: ", round(100*(1-sum(diag(test.results))/sum(test.results)),2),"%",sep="")
```
